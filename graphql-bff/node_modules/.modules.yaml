...
hoistedDependencies:
  ...
  /apollo-server-core/3.6.1_graphql@15.8.0:
    apollo-server-core: private
  /apollo-server-env/4.2.0:
    apollo-server-env: private
  /apollo-server-errors/3.3.0_graphql@15.8.0:
    apollo-server-errors: private
  /apollo-server-express/3.6.1_express@4.17.2+graphql@15.8.0:
    apollo-server-express: private
  /apollo-server-plugin-base/3.5.0_graphql@15.8.0:
    apollo-server-plugin-base: private
  /apollo-server-types/3.5.0_graphql@15.8.0:
...
pendingBuilds: []
prunedAt: Sat, 22 Jan 2022 15:46:02 GMT
publicHoistPattern:
  - '*types*'
  - '*eslint*'
  - '@prettier/plugin-*'
